...
export default memo(function Hub() {
  ...
  return (
    <div id="page-hub">
      <div className="page-label"><span className="idx">6</span><span>{t('hub_page_label')}</span><span className="path">/hub</span></div>
        ...
        <div className="card device-table">
          <div className="card-h">{t('hub_lbl_devices')} · {displayDevices.length}
            <div className="actions">
              <button className="btn btn-sm btn-ghost" onClick={() => { window.dispatchEvent(new CustomEvent('nav-to', { detail: 'quickconnect' })) }}>{t('hub_add_device') || '+ Add device'}</button>
